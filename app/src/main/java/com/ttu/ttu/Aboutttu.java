...
/**
 * Created by wind1209 on 2017/2/23.
 */

public class Aboutttu extends Activity {
    ...
    public void onBackPressed() {
        webView.stopLoading();
        Intent intent = new Intent(Aboutttu.this, Menu.class);
        Aboutttu.this.startActivity(intent);
        Aboutttu.this.finish();
